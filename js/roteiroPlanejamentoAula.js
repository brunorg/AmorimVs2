...
//var dataObjetivo 				=	getData("ObjetivoAula", null);
//console.log(dataObjetivo);
//var dataAtividade 				=	getData("Atividade", null);

//var dataProducaoAluno 			=	getData("ProducaoAluno", null);
//var dataPlanejamentoRoteiro 	=	getData("PlanejamentoRoteiro/aluno" , professorID); 
...
//	}
	...
	for(var a = 0; a < dataRoteiro.length; a++){
		//console.log(dataRoteiro[a]);
		//IdRoteiro[a] = dataRoteiro[a].descricao;	
		HtmlContent = "";
...
//		HtmlContent += "<div class='td_titulo_recurso'>Recursos de aprendizagem</div>";
		//HtmlContent += "<table class='tb_right'>";
		//HtmlContent += getRecursosDeRoteiro(dataRoteiro[a].idroteiro_aula);
//		HtmlContent += "</table>";
		HtmlContent += "</div>" ;
		HtmlContent += "<div style='clear: both;''> </div>"			
...
//	console.log(texto);
	...
	//nao aparece n prmwir vezz... VERIFICAR
	if ($(".box_"+Id).is(":visible")){
		//console.log('esconder tudo');
		$(".box_"+Id).hide();
	}else{
		//console.log('Exibir!!!');
		$('.box_oculto').hide();
	...
	Limite = dataObjetivo.length;
        ...
        for(var a = 0; a < Limite; a++){
			...
			//if(removeClick == false){
				//HtmlContent +=				'<div onclick="trocarObjetivoStatus(this,'+dataObjetivoByRoteiro[a].idobjetivo+','+(PlanoEstudoSessionID)+','+IDplanejamentoRoteiro+');" class="titulo_infos_roteiro_caixa_'+Cor+'" id="td_objetivo_squr_'+dataObjetivoByRoteiro[a].idobjetivo+'" ></div>';
			...
			//}else{
			//	HtmlContent +=					'<div class="titulo_infos_roteiro_caixa_'+Cor+'" id="td_objetivo_squr_'+dataObjetivo[a].idobjetivo_aula+'" ></div>';
			//}
	    	...
	    	HtmlContent +=					"</div>"+
	    					...
	    					"</div>";
    		num++;
			//HtmlContent += "<td class='td_ativ'>"+dataObjetivo[a].objetivo;
...
//	var ultimoPlano = getUltimoPlanoEstudo();
	...
	$.ajax({
		...
		//console.log(dataObjetivoByRoteiro);
...
//				}
				...
				num = a+1;
//				RetornoHtml +='<div class="ObjLeft Obj_'+dataObjetivoByRoteiro[a].idobjetivo_aula+'" style="display:block">'+
//					'<div class="titulo_infos_roteiro">'+
//						'<div class="td_roteiro_numero_tabela">'+
//							num
//						'</div>'+
//						'<div class="td_titulo_tabela">'+
//							'<a onclick="ApareceAtiv('+dataObjetivoByRoteiro[a].idobjetivo_aula+')">'+
//								dataObjetivoByRoteiro[a].objetivo+
//							'</a>'+
//							'<div class="titulo_infos_roteiro_botoes">'+
//								'<div id="ObjStatus_'+dataObjetivoByRoteiro[a].idobjetivo_aula+'" class="titulo_infos_roteiro_estrela">';
...
//				}	
				...
				//$('.QuadObj_'+dataObjetivoByRoteiro[a].roteiro.idroteiro_aula).append('<td onclick="setObjetivoStatus(this,'+IDplanejamentoRoteiro+','+dataObjetivoByRoteiro[a].idobjetivo_aula+','+IDplanoEstudo+','+dataObjetivoByRoteiro[a].roteiro.idroteiro_aula+');" class="td_roteiro_'+Cor+'" id="td_roteiro_squr_'+dataObjetivoByRoteiro[a].idobjetivo_aula+'">'+num+'</td>');
