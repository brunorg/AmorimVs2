...
function criarPaineisDosAlunos(idDivGrupo, retornoAjax) {
	for (var i = retornoAjax.length - 1; i >= 0; i--) {
		...
		if(/Android|webOS|iPhone|iPad|iPod|BlackBerry/i.test(navigator.userAgent))
			$('#' + idDivGrupo + " .grupoBlocoNomes .caixaGL .grupoLinhaAluno#aluno" + i).append('<a href=\"m_grupoTutoria.html?ID='+base64_encode(""+retornoAjax[i].idProfessor)+'\"> <div class="grupoFotoAluno"></div> </a>')
      	else
